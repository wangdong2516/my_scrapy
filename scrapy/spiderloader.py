...
class SpiderLoader:
    ...
    def __init__(self, settings: BaseSettings):
        self.spider_modules: list[str] = settings.getlist("SPIDER_MODULES")  # 获取settings配置文件中指定的SPIDER_MODULES配置项
        ...
        self._load_all_spiders()  # 加载所有的爬虫,也就是settings文件中定义的SPIDER_MODULES配置项,将其写入self._spiders字典中
    ...
    def load(self, spider_name: str) -> type[Spider]:
        ...
        """
        try:
            return self._spiders[spider_name]  # 从所有加载后的自定义爬虫中，加载当前的爬虫
        except KeyError:
